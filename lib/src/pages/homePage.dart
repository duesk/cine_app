          ...
          children: <Widget>[
            ...
            StreamBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot<List> snapshot) {
                ...
                return (snapshot.hasData)? MovieHorizontal(peliculas: snapshot.data,siguientePagina: peliculasProvider.getPopulares,):CircularProgressIndicator();
